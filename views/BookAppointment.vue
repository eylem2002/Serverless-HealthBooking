...
export default {
  ...
  mounted() {
    fetch("https://hldnlmhee0.execute-api:us-east-1:730335665786:hldnlmhee0/*/GET/slots")
      .then(res => res.json())
      .then(data => {
  ...
  methods: {
    submitAppointment() {
      ...
      fetch("https://hldnlmhee0.execute-api:us-east-1:730335665786:hldnlmhee0/*/POST/appointments", {
        method: "POST",
